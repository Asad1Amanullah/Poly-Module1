...
const ABI = require("../artifacts/contracts/ghost.sol/ghost.json");
...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("ghost");
  const nft = await NFT.attach("0x478002A12b40A42cC55A00a7D7433756CD07Cdd2");
